package com.easy_life.med.adapters
...
import com.easy_life.med.databinding.AdListItemBinding
...
class AdsRcAdapter(val act: MainActivity) : RecyclerView.Adapter<AdsRcAdapter.AdHolder>() {
    ...
    class AdHolder(val binding: AdListItemBinding, val act: MainActivity, val formatter: SimpleDateFormat) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun setData(ad: Ad) = with(binding) {
            ...
            tvClinicTemp.text = ad.clinic
            tvDirectionTemp.text = ad.direction
            tvDocumentTemp.text = ad.document
